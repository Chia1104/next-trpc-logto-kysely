  ...
  return (
    <Drawer.Root shouldScaleBackground>
      <Drawer.Trigger asChild>
        <Button isIconOnly color="secondary" aria-label="edit">
          <svg
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 z-[999] mt-24 flex h-[96%] flex-col rounded-t-[10px] bg-zinc-100">
